...
import 'package:access_control_flutter/managers/mqtt/mqtt_manager.dart';
import 'package:access_control_flutter/managers/database/database_manager.dart';
import 'package:access_control_flutter/managers/database/drink_history.dart';
import 'package:access_control_flutter/managers/notifications/notifications_manager.dart';
import 'package:access_control_flutter/managers/settings/app_settings_manager.dart';
...
List<Middleware<AppState>> createStoreMiddleware() {
  ...
  final mqttPublish = _CreateMqttPublish();
  ...
  return [
    ...
    TypedMiddleware<AppState, MqttPublishAction>(mqttPublish),
  ];
}
...
Middleware<AppState> _mqttPublish() {
  return (Store<AppState> store, action, NextDispatcher next) {
    DatabaseManager.defaultManager.remove([action.entry]);
